...
class _MyRegisterWidget extends State<RegisterWidget>
  ...
  final Map<String, String> _wsExtraHeaders = {
    'Origin': '208.89.104.21',
    'Host': '208.89.104.21:5060'
  };
  ...
  void _loadSettings() async {
    ...
    setState(() {
      _wsUriController.text =
          _preferences.getString('ws_uri') ?? '208.89.104.21:5060';
      _sipUriController.text =
          _preferences.getString('sip_uri') ?? '208.89.104.21:5060';
      _displayNameController.text =
          _preferences.getString('display_name') ?? 'Joshua';
      _passwordController.text = _preferences.getString('password') ?? 'joshua1';
      _authorizationUserController.text =
          _preferences.getString('auth_user') ?? '23402093010015';
    });
  }
  ...
  void _handleSave(BuildContext context) {
    ...
    // settings.dtmfMode = DtmfMode.RFC3261;
